...
public class AppContentProvider extends ContentProvider {
    ...
    private static final String PATH_ARTICLES = "users";
    private static final String PATH_GROUPS = "groups";

    public static final Uri CONTENT_URI_ARTICLE = Uri.parse("content://" + AUTHORITY + "/" + PATH_ARTICLES);
    public static final Uri CONTENT_URI_GROUPS = Uri.parse("content://" + AUTHORITY + "/" + PATH_GROUPS);

    private static final int CODE_ARTICLE = 0;
    private static final int CODE_GROUPS = 1;

    private static final UriMatcher URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);

    static {
        URI_MATCHER.addURI(AUTHORITY, PATH_ARTICLES, CODE_ARTICLE);
