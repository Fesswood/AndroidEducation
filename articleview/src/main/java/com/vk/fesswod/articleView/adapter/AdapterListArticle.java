 ...
 */
public class AdapterListArticle  extends ArrayAdapter<Article> implements View.OnClickListener {

    private final Context mContext;
    private LinkedList<Article> mFilteredModelItemsArray;
    private LayoutInflater mInflater;

    public AdapterListArticle(Context context, List<Article> objects) {
        super(context, R.layout.view_list_tem);
        mContext=context;
